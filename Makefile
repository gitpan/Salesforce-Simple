# This Makefile is for the Salesforce::Simple extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Salesforce/Simple.pm]
#     AUTHOR => q[Chase Whitener <cwhitener@gmail.com>]
#     NAME => q[Salesforce::Simple]
#     PREREQ_PM => { Salesforce=>q[0.54] }
#     VERSION_FROM => q[lib/Salesforce/Simple.pm]
...
FULLEXT = Salesforce/Simple
BASEEXT = Simple
PARENT_NAME = Salesforce
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Salesforce/Simple.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Salesforce/Simple.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DIRFILESEP)Config.pm $(PERL_INC)$(DIRFILESEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Salesforce
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Salesforce
...
TO_INST_PM = lib/Salesforce/Simple.pm

PM_TO_BLIB = lib/Salesforce/Simple.pm \
	blib/lib/Salesforce/Simple.pm
...
DISTNAME = Salesforce-Simple
DISTVNAME = Salesforce-Simple-0.04
...
manifypods : pure_all  \
	lib/Salesforce/Simple.pm \
	lib/Salesforce/Simple.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW)\
	  lib/Salesforce/Simple.pm $(INST_MAN3DIR)/Salesforce::Simple.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/Salesforce/Simple.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Salesforce-Simple' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.04' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Salesforce/Simple.pm' >> META.yml
	$(NOECHO) $(ECHO) 'installdirs:  site' >> META.yml
	$(NOECHO) $(ECHO) 'requires:' >> META.yml
	$(NOECHO) $(ECHO) '    Salesforce:                    0.54' >> META.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Chase Whitener &lt;cwhitener@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Salesforce" VERSION="0,54,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/Salesforce/Simple.pm blib/lib/Salesforce/Simple.pm 
	$(NOECHO) $(TOUCH) $@
